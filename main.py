...
show_pages(
    [
        ...
        Page("pages/mancanti.py",        "[2.1.0.4] Gestione dei valori anomali", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] Gestione dei mancanti", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] Trasformazione dei dati", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] Pulizia dei dati di testo", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] Standardizzazione dei dati - feature scaling", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] Codifica delle etichette", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] One-hot encoding", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] Gestione dei dati sbilanciati", icon=":signal_strength:"),
        Page("pages/mancanti.py",        "[2.1.0.4] Trappola delle variabili fittizie nei modelli di regressione", icon=":signal_strength:"),
